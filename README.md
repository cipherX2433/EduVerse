# Eduvers Online Education Platform

![Main Page](images/mainpage.png)

## Project Description

Eduverse is a fully functional ed-tech platform that enables users to create, consume,
...
The Eduverse ed-tech platform consists of three main components: the front end, the
...
The database for the platform is built using postgresql, which is a SQL database that
provides a flexible and scalable data storage solution. postgresql allows for the storage of
